...
public abstract class SearchEngine {
	...
	protected int prf; // whether to use prf and how many patents to consider
						// (defined in the query with the symbol '#')
	...
	// (with your improved visualization) in an ArrayList of Strings
